//
//  WSChartWebsiteVisitorsBarTouching.m
//  PowerPlot
//
...
@implementation WSChartWebsiteVisitorsBarTouching

- (NSString *)title
{
    return NSLocalizedString(@"Website Visitors, touching bars", @"");
}

- (NSString *)chartDescription
{
    return NSLocalizedString(@"A touching bar chart with the field-theory.org web traffic", @"");
}
